...
BETA=zeros(maxiter, 10); % contains the ``within", infeasible, the Interative effects, and the naive estimators
SIGMA=zeros(maxiter,1);
NNN=zeros(maxiter,1);   % the number of iterations to achieve convergence 
